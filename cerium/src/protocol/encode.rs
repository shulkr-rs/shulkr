...
use crate::{
    protocol::{
        ...
        packet::{
            ...
            SystemChatMessagePacket, UnloadChunkPacket, UpdateAdvancemensPacket,
            UpdateObjectivesPacket, UpdateTagsPacket, WorldEventPacket,
            server::{
    ...
    P: Packet + ServerPacket,
{
    Some(match () {
        ...
        // _ if type_id == TypeId::of::<PlayerChatPacket>() => 0x41,
        ...
        _ if type_id == TypeId::of::<UpdateAdvancemensPacket>() => 0x6E,
